...
//   node scripts/fetch-docs.mjs               clone if missing, otherwise fast-forward to the latest feat/jiuwenswarm
...
const branch = process.env.PRODUCT_BRANCH || 'feat/jiuwenswarm'
